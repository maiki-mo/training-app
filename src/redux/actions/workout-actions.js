import { FETCH_WORKOUTS, UPDATE_MILES, COMPLETE_WORKOUT, UNCOMPLETE_WORKOUT, SAVE_WORKOUT } from './types';
...
export const unCompleteWorkout = (week, day) => {
  return (dispatch) => {
    dispatch({
      type: UNCOMPLETE_WORKOUT,
      payload: {
        week,
        day,
      },
